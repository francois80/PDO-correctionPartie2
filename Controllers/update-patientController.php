...
if ($isSubmitted && count($errors) == 0) {
    ...
    $success = true;
    $sleep = 4;
    header('Refresh:' . $sleep . ';http://www.pdo-partie2-correction.com/Controllers/profil-patientController.php?idPatient='. $patient->id);
}
if (!$patient->getOneById()) {
    echo 'Ce patient n\'existe pas';
    $sleep = 4;
    header('Refresh:' . $sleep . ';http://www.pdo-partie2-correction.com/Controllers/list-patientsController.php');
}
