...
if(isset($_SESSION['deletePatient']) && $_SESSION['deletePatient']['success']){
?>
<p class="alert alert-success">Le compte de <?= trim(htmlspecialchars($_SESSION['deletePatient']['name'])) ?> a été supprimé</p>
<?php
...
<div class="justify-content-center d-flex">
    <a href="addPatientsController.php" class="btn btn-lg btn-primary">Ajouter des patients</a>
</div>
<?php
